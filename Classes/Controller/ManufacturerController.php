...
class ManufacturerController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
     ...
     *
     * @var \FFPI\FfpiRouter\Domain\Repository\ManufacturerRepository
     * @inject
     */
     ...
     * action show
     *
     * @param \FFPI\FfpiRouter\Domain\Model\Manufacturer $manufacturer
     * @return void
     */
    public function showAction(\FFPI\FfpiRouter\Domain\Model\Manufacturer $manufacturer)
    {
